...
**Contexto:** Após pull de 27 commits. Diagnóstico atual em [`PENDENCIAS-DESENVOLVIMENTO.md`](./PENDENCIAS-DESENVOLVIMENTO.md). Plano executável em [`PLANO-DESENVOLVIMENTO.md`](./PLANO-DESENVOLVIMENTO.md).
...
- `docs/arquitetura/ARQUITETURA.md` — arquitetura, componentes críticos, deploy
- `docs/archive/auditoria/Divergencias.md` — análise comparativa com versão antiga
- `docs/ops/vercel-config.md` — roadmap rápido para Vercel
...
Referência principal: [`vercel-config.md`](../ops/vercel-config.md) e [`ARQUITETURA.md`](../arquitetura/ARQUITETURA.md).
...
Checklist derivado de [`Divergencias.md`](../archive/auditoria/Divergencias.md).
