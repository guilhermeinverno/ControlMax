...
> Documentos satélite: [`ARQUITETURA.md`](./ARQUITETURA.md) (legado/ponte), [`PENDENCIAS-DESENVOLVIMENTO.md`](./PENDENCIAS-DESENVOLVIMENTO.md), [`PLANO-DESENVOLVIMENTO.md`](./PLANO-DESENVOLVIMENTO.md), [`AGENTS.md`](../AGENTS.md), [`docs/controlmax/`](../docs/controlmax/00-indice.md).
...
├── backend/        # Express (BFF) + Firebase Admin SDK + Gemini (`@google/genai`)
├── documentation/  # SSOT, planos, QA Gate, runbooks
├── docs/controlmax/# Spec de produto / ADRs
├── firestore.rules
...
| `security_logs`, `audit_logs` | create/update/delete false |
...
Deploy Gate: [`DEPLOY-FIRESTORE-GATE.md`](./DEPLOY-FIRESTORE-GATE.md) — `firebase deploy --only firestore:rules,firestore:indexes`.  
...
| Deploy rules/indexes | Ops — [`DEPLOY-FIRESTORE-GATE.md`](./DEPLOY-FIRESTORE-GATE.md) |
| SYNC-01 + QA regressivo | QA — [`SYNC-01-CHECKLIST-QA.md`](./SYNC-01-CHECKLIST-QA.md), [`GATE-PILOTO-QA.md`](./GATE-PILOTO-QA.md) |
